...
​25% increase in unique monthly visitors. 

​2-3% conversion rate for online sales.

​Growth in email subscribers by 100+ members monthly.
...
​Headings: Playfair Display (Serif) – to evoke a sense of timeless elegance and history.

​Body Text: Montserrat (Sans-serif) – for modern readability and a clean "London boardroom" aesthetic.

​Color Palette: Warm golds, emerald, and deep terracotta to highlight the 18K gold-plated vermeil products.

​Layout: Clean, white-space heavy design inspired by the minimalism found in modern luxury boutiques.



​4. Key Features and Functionality

​Homepage: Introduction to brand identity and heritage concept with clear navigation.

​Product Catalogue: Detailed pages for Minakari and Kundan collections with pricing and material specs.
...
​About Us (about.html) — Background on heritage, mission, and the artisans behind the jewellery.

​Products (products.html) — The main catalogue showcasing Minakari and Kundan collections.

​Payment & Checkout (payment.html) — Secure interface for processing transactions and shipping details.
...
​Frameworks: Utilizing Liquid (Shopify’s templating language) for future scale.
...
​2026-04-27: Pushed the project to the GitHub repository and verified the remote connection.
